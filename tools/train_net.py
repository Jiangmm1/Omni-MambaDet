...
# ==============================================================================
# 修复 PyTorch 2.6+ 加载旧版 checkpoint 报错的问题 (WeightsUnpickler error)
# 强制将 weights_only 默认为 False，模拟 PyTorch 2.5 及之前的行为
# ==============================================================================
...
print("HACK: 已强制覆盖 torch.load 默认行为，允许加载所有全局对象 (weights_only=False)")
# ==============================================================================
...
def do_train(args, cfg):
    ...
    logger.info(f"🚀 [Model Stats] 当前模型总参数量 (Total): {total_params / 1e6:.2f} M")
    logger.info(f"🔥 [Model Stats] 可训练参数量 (Trainable): {trainable_params / 1e6:.2f} M")
